...
theme.set_highlights = function(opts)
    ...
    hl(0, 'CursorLineNr',                  { fg = c.spiceWhite,                                       bg = c.Back })
    ...
    hl(0, 'Pmenu',                         { fg = c.spiceWhite,                                       bg = c.spiceGray })
    hl(0, 'PmenuSel',                      { fg = c.spiceWhite,                                       bg = c.PopupHighlightBlue })
    hl(0, 'PmenuSbar',                     { fg = 'NONE',                                             bg = c.PopupHighlightGray })
    hl(0, 'PmenuThumb',                    { fg = 'NONE',                                             bg = c.spiceWhite })
    ...
    hl(0, 'Special',                       { fg = c.spiceTeal,                                        bg = 'NONE' })
    ...
    hl(0, '@comment',                      { fg = c.spiceComment,                                     bg = 'NONE',      italic = opts.italic_comments })
    hl(0, '@constant',                     { fg = c.spiceTeal,                                     bg = 'NONE' })
    ...
    hl(0, '@string',                       { fg = c.spiceGreen,                                       bg = 'NONE' })
    hl(0, '@character',                    { fg = c.spiceGreen,                                       bg = 'NONE' })
    hl(0, '@number',                       { fg = c.spiceTeal,                                     bg = 'NONE' })
    hl(0, '@boolean',                      { fg = c.spiceTeal,                                     bg = 'NONE' })
    hl(0, '@float',                        { fg = c.spiceTeal,                                     bg = 'NONE' })
    ...
    hl(0, '@property',                     { fg = c.spicePink,                                            bg = 'NONE' })
    ...
    hl(0, '@type',                         { fg = c.spiceMagenta,                                     bg = 'NONE' })
    hl(0, '@type.builtin',                 { fg = c.spiceMagenta,                                     bg = 'NONE' })
    ...
    hl(0, 'CmpItemMenu',                   { fg = c.spiceWhite,                                       bg = 'NONE' })
    hl(0, 'CmpItemAbbr',                   { fg = c.Front,                                            bg = 'NONE' })
    hl(0, 'CmpItemAbbrDeprecated',         { fg = c.CursorDark,                                       bg = c.spiceGray, strikethrough = true })
    ...
    -- Telescope
    hl(0, 'TelescopePromptBorder',         { fg = c.LineNumber,                                       bg = c.spiceGray })
    hl(0, 'TelescopeResultsBorder',        { fg = c.LineNumber,                                       bg = c.spiceGray })
    hl(0, 'TelescopePreviewBorder',        { fg = c.LineNumber,                                       bg = c.spiceGray })
    hl(0, 'TelescopeNormal',               { fg = c.Front,                                            bg = c.spiceGray })
    hl(0, 'TelescopeSelection',            { fg = c.Front,                                            bg = c.UiBlue })
    hl(0, 'TelescopeMultiSelection',       { fg = c.Front,                                            bg = c.UiBlue })
    hl(0, 'TelescopeMultiIcon',            { fg = c.spiceTeal,                                            bg = 'NONE' })
    hl(0, 'TelescopeMatching',             { fg = c.spiceOrange,                                            bg = 'NONE',      bold = true })
    hl(0, 'TelescopePromptPrefix',         { fg = c.Front,                                            bg = 'NONE' })

    -- Navic
    hl(0, 'NavicText',               {fg = c.Gray, bg = c.Back})
    hl(0, 'NavicSeparator',          {fg = c.Gray, bg = c.Back})
...
theme.link_highlight = function()
    ...
    -- Navic
    hl(0, 'NavicIconsFile',          { link = '@text'})
    hl(0, 'NavicIconsModule',        { link = '@text'})
    hl(0, 'NavicIconsNamespace',     { link = '@text'})
    hl(0, 'NavicIconsPackage',       { link = '@text'})
    hl(0, 'NavicIconsClass',         { link = '@text'})
    hl(0, 'NavicIconsMethod',        { link = '@text'})
    hl(0, 'NavicIconsProperty',      { link = '@text'})
    hl(0, 'NavicIconsField',         { link = '@text'})
    hl(0, 'NavicIconsConstructor',   { link = '@text'})
    hl(0, 'NavicIconsEnum',          { link = '@text'})
    hl(0, 'NavicIconsInterface',     { link = '@text'})
    hl(0, 'NavicIconsFunction',      { link = '@function.call'})
    hl(0, 'NavicIconsVariable',      { link = '@text'})
    ...
    hl(0, 'NavicIconsArray',         { link = '@text'})
    hl(0, 'NavicIconsObject',        { link = '@text'})
    hl(0, 'NavicIconsKey',           { link = '@text'})
    hl(0, 'NavicIconsNull',          { link = '@text'})
    hl(0, 'NavicIconsEnumMember',    { link = '@text'})
    hl(0, 'NavicIconsStruct',        { link = '@type'})
    hl(0, 'NavicIconsEvent',         { link = '@text'})
    hl(0, 'NavicIconsOperator',      { link = '@text'})
    hl(0, 'NavicIconsTypeParameter', { link = '@text'})
end
